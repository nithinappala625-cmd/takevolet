            ...
            {allImages.length > 0 ? (
              <div className="space-y-4">
                <div className="aspect-[16/9] relative overflow-hidden bg-secondary/30 rounded-xl border border-border">
                  <Image src={allImages[activeImage]} unoptimized={true} alt={property.title || "Property"} fill className="object-cover" />
                </div>
                {allImages.length > 1 && (
              ...
              {property.profiles ? (
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-border">
                  {property.profiles.avatar_url ? (
                    <Image src={property.profiles.avatar_url} unoptimized={true} alt="" width={56} height={56} className="rounded-full object-cover border-2 border-primary/20" />
                  ) : (
