...
import FlatmateDetailPage from "@/app/flatmates/[id]/page";
import { Smartphone, Download } from "lucide-react";

export default function FlatmateDetailClient({ flatmateId }: { flatmateId: string }) {
  const deepLink = `takevolet://flatmate/${flatmateId}`;
